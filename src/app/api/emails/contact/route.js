...
message: ${message}`,
    ...
    <thead>
        <tr>
            <th style="background-image: url('https://adfluentica.com/images/letter-top.png'); background-size: cover;background-position: center center; background-repeat: no-repeat; height: 117px;"></th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td style="padding: 50px 40px; font-family: Roboto, sans-serif; color:#0A0A0A;">
                ...
                <p style="font-size: 16px; line-height: 19px;">Thank you for reaching out to us! We have received your message and appreciate you taking the time to contact Adfluentica.</p>
    ...
    <tfoot>
        <tr>
            <td style="background-color: #333333; font-weight: 600; font-family: Roboto, sans-serif;padding: 30px 0;">
                <a href="https://adfluentica.com/"><img src="https://adfluentica.com/images/letter-bottom.png" alt="Adfluentica"></a>
            </td>
        </tr>
    </tfoot>
</table>
